...
class CancelarVooDialog(ComponentDialog):
    def __init__(self, dialog_id: str = None):
        super(CancelarVooDialog, self).__init__(dialog_id or CancelarVooDialog.__name__)
    ...
    async def codigo_reserva_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        prompt_text = "Por favor, informe o código da reserva de voo que deseja cancelar."
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        if step_context.result:
            ...
            # TODO: Adicionar lógica para cancelar a reserva de voo
            msg_text = f"Cancelando reserva de voo {codigo_reserva}... (funcionalidade em desenvolvimento)."
