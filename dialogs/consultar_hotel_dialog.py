...
class ConsultarHotelDialog(ComponentDialog):
    def __init__(self, dialog_id: str = None):
        super(ConsultarHotelDialog, self).__init__(dialog_id or ConsultarHotelDialog.__name__)
    ...
    async def codigo_reserva_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        prompt_text = "Por favor, informe o código da sua reserva de hotel."
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        # TODO: Adicionar lógica para consultar a reserva de hotel
        msg_text = f"Consultando reserva de hotel {codigo_reserva}... (funcionalidade em desenvolvimento)."
